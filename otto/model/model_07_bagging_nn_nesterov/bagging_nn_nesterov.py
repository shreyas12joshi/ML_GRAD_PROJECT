"""
Mean log loss from 5-fold CV: 0.461952014711
"""
import copy
import itertools
import numpy as np
...
if __name__ == '__main__':
    ...
    clf_nn = NeuralNetwork(750, 110, 116, 0.0012503331803251808, 0.9544425038759606, 0.3992570325984604,
                           .05, True, 10, random_state=23)

    clf = ensemble.BaggingClassifier(base_estimator=clf_nn, n_estimators=10,
